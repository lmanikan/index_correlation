...
class BigQueryResultsWriter(ResultsWriter):
    ...
    def __init__(
        ...
        try:
            ...
            raise WriterConnectionError(f"Failed to connect to BigQuery: {e}") from e
    ...
    def _write_intraday_correlations(self, df: pd.DataFrame, as_of: datetime) -> None:
    ...
    def _upsert_latest_sensitivities(self, df: pd.DataFrame, as_of: datetime) -> None:
    ...
    def _upsert_daily_correlations(self, df: pd.DataFrame, as_of: datetime) -> None:
